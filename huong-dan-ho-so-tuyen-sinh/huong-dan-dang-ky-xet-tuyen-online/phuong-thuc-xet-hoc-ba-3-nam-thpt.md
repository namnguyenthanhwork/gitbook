...
![1 bảng thông báo giới thiệu sẽ hiện ra, nhớ đọc kỹ rồi hãy ấn tiếp tục](../../.gitbook/assets/hb.PNG)
...
* [x] Điền đối tượng ưu tiên (<mark style="color:red;">**đọc đối tượng ưu tiên ở bên dưới**</mark>** ** trước khi chọn, nếu không thuộc loại nào thì điền <mark style="color:red;">**"Không ưu tiên"**</mark><mark style="color:red;">)</mark>
...
{% hint style="info" %}
**Lưu ý:** đọc quy định thay đổi khu vực ưu tiên **(bên dưới)** sau đó nếu thấy hộ gia đình thuộc dạng được đề cập trong quy chế thì ấn tick chọn rồi nhập các thông tin như bên dưới <mark style="color:red;">**(chụp toàn bộ ảnh hộ khẩu)**</mark>, nếu không thì bỏ tick chọn và ấn tiếp tục. <mark style="color:red;">**(Nếu tick chọn sai thì coi như từ chối nhập học)**</mark>
{% endhint %}
...
![thay đổi khu vực ưu tiên theo hộ gia đình](<../../.gitbook/assets/c5 hsg.PNG>)
...
**Bước 2: lấy email đã đăng ký xét online, gửi mail đến** [_<mark style="color:red;">**duy.nhv@ou.edu.vn**</mark>_](mailto:duy.nhv@ou.edu.vn) **với nội dung như trong hình**

![Bước 2: lấy email đã đăng ký xét online, gửi mail đến duy.nhv@ou.edu.vn với nội dung như trong hình](<../../.gitbook/assets/b2 sua pt xet tuyen.PNG>)
